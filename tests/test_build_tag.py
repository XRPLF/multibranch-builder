...
from xrpld_compose import build, cli
...
@patch("xrpld_compose.build._submit", return_value=("build-1", "SUCCESS"))
...
@patch("xrpld_compose.build.ci_image_for", return_value="ghcr.io/xrplf/xrpld/nix-ubuntu:sha-x")
@patch("xrpld_compose.build._submit", return_value=("build-2", "SUCCESS"))
...
@patch("xrpld_compose.build._run")
@patch("xrpld_compose.build.shutil.which", return_value="/usr/bin/gh")
...
@patch("xrpld_compose.build.submit_tree")
...
@patch("xrpld_compose.build.submit_branch")
@patch("xrpld_compose.build.resolve_sha", return_value=SHA)
